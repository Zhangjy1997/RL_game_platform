...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.poker_symmetry_runner import POKER_Sigma_Runner as Runner
    else:
        from onpolicy.runner.separated.poker_symmetry_runner import POKER_Sigma_Runner as Runner
