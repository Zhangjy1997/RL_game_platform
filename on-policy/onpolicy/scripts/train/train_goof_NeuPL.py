...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.goofspiel_symmetry_runner import POKER_Sigma_Runner as Runner
    else:
        from onpolicy.runner.separated.goofspiel_symmetry_runner import POKER_Sigma_Runner as Runner
