...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.ball_psro_runner import BALL_Sigma_Runner as Runner
    else:
        from onpolicy.runner.separated.ball_psro_runner import BALL_Sigma_Runner as Runner
