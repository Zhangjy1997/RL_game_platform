...
CUDA_VISIBLE_DEVICES=0 python3 ../train/train_uav_NeuPL_symmetry.py \
...
--critic_lr 0.00001 --lr 0.00001 --total_round 80 --use_mix_policy --population_size 5 --eval_episode_num 10 --channel_interval 1 --use_fast_update --update_T 600 \
--role_number 0 --policy_backup_dir "/home/qiyuan/workspace/policy_backup/neupl_symmetry_20240316" #--role_number 0 #--use_warmup False
