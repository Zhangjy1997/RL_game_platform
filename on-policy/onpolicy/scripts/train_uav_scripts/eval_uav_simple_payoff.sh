...
CUDA_VISIBLE_DEVICES=0 python3 ../eval/eval_uav_simple_payoff.py \
...
--dir_pursuer "/home/qiyuan/workspace/policy_backup/neupl_FNR_20240313" --PT_pursuer "frozen_policy" --dir_evader "/home/qiyuan/workspace/policy_backup/neupl_FNR_20240313" --PT_evader "neupl" --num_policy_p1 100 --num_policy_p2 100
