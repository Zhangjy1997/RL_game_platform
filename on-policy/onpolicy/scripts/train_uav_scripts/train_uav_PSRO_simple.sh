...
# train param
num_env_steps=16000000
# episode_length=400

# echo "n_rollout_threads: ${n_rollout_threads} \t ppo_epoch: ${ppo_epoch} \t num_mini_batch: ${num_mini_batch}"

CUDA_VISIBLE_DEVICES=0 python3 ../train/train_uav_PSRO_simple.py \
...
--critic_lr 0.00001 --lr 0.00001 --total_round 80 --use_mix_policy --population_size 2 --eval_episode_num 15 --channel_interval 1 \
--role_number 0 --until_flat --policy_backup_dir "/home/qiyuan/workspace/policy_backup/neupl_WF_20240325" #--role_number 0 #--use_warmup False
