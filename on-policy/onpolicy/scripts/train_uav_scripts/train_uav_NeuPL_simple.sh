...
# train param
num_env_steps=8076800
# episode_length=400

# echo "n_rollout_threads: ${n_rollout_threads} \t ppo_epoch: ${ppo_epoch} \t num_mini_batch: ${num_mini_batch}"

CUDA_VISIBLE_DEVICES=0 python3 ../train/train_uav_NeuPL_simple.py \
...
--user_name "leakycauldron" --wandb_name "first-trial" --d_k 8 --n_head 4 --layer_N 2 --encoder_layer_N 1 --hidden_size 128 --encoder_hidden_size 32 --attn_size 24 --recurrent_N 2 \
--critic_lr 0.00001 --lr 0.00001 --total_round 10 --use_mix_policy --population_size 9 --eval_episode_num 10 \
