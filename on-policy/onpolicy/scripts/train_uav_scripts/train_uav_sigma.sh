...
CUDA_VISIBLE_DEVICES=0 python3 ../train/train_uav_NeuPL_sigma.py \
...
--user_name "leakycauldron" --wandb_name "first-trial" --d_k 8 --n_head 4 --layer_N 1 --encoder_layer_N 1 --hidden_size 128 --encoder_hidden_size 32 --attn_size 24 --use_mixer \
--critic_lr 0.00005 --lr 0.00005 --total_round 2 --use_mix_policy --population_size 3 --eval_episode_num 1 --channel_interval 1 \
