...
--env_name ${env} --scenario_name ${scenario} --algorithm_name ${algo} --experiment_name ${exp} --seed 321 \
...
--critic_lr 0.00001 --lr 0.00001 --total_round 120 --use_mix_policy --population_size 33 --eval_episode_num 30 --channel_interval 1 --use_fast_update --update_T 500 \
--role_number 0 --policy_backup_dir "/home/qiyuan/workspace/policy_backup/neupl_goofspiel_20240519_seed321" #--role_number 0 #--use_warmup False
