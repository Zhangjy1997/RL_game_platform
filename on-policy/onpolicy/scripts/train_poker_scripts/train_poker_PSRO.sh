...
--critic_lr 0.00001 --lr 0.00001 --total_round 100 --use_mix_policy --population_size 51 --eval_episode_num 20 \
--sub_round 2 --until_flat --policy_backup_dir "/home/qiyuan/workspace/policy_backup/PSRO_poker_20240417" #--role_number 0 #--use_warmup False
