...
CUDA_VISIBLE_DEVICES=0 python3 ../train/train_ball_P2SRO.py \
...
--critic_lr 0.00001 --lr 0.00001 --total_round 100 --use_mix_policy --population_size 33 --eval_episode_num 10 --channel_interval 1 \
--role_number 0 --window_length 4 --policy_backup_dir "/home/qiyuan/workspace/policy_backup/P2SRO_ball_20240402" #--role_number 0 #--use_warmup False
