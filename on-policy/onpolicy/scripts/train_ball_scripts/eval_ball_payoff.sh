...
CUDA_VISIBLE_DEVICES=0 python3 ../eval/eval_ball_payoff.py \
...
--dir_player1 "/home/qiyuan/workspace/policy_backup/neupl_ball_20240316/round30" --PT_player1 "neupl" --dir_player2 "/home/qiyuan/workspace/policy_backup/neupl_WF__ball_20240319/round30" --PT_player2 "frozen_policy" --num_policy_p1 100 --num_policy_p2 100 --use_payoff_eval
