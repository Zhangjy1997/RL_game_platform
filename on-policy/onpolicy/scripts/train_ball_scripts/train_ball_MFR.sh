...
CUDA_VISIBLE_DEVICES=0 python3 ../train/train_ball_MFR.py \
...
--role_number 0 --upper_epsilon 0.1 --sub_policy_num 2 --policy_backup_dir "/home/qiyuan/workspace/policy_backup/neupl_MFR_20240401" #--role_number 0 #--use_warmup False
