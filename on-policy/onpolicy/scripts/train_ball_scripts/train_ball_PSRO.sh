...
CUDA_VISIBLE_DEVICES=0 python3 ../train/train_ball_PSRO.py \
...
--critic_lr 0.00001 --lr 0.00001 --total_round 80 --use_mix_policy --population_size 9 --eval_episode_num 15 \
--sub_round 2 --use_empty_policy --policy_backup_dir "/home/qiyuan/workspace/policy_backup/neupl_WF__ball_20240318" #--role_number 0 #--use_warmup False
