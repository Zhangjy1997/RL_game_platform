...
def main(args):
    ...
    eval_envs.world.oppo_policy = Evader_rule_policy(empty_policy, max_vel=7, max_heading_rate=0.57/2, mat_path=mat_path, grid=grid, pos_p_inx= pos_p_in, device = device)
